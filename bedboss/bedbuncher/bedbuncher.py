...
def run_bedbuncher(
    ...
    :param backend: analysis backend ("r" or "gtars"). When "gtars", heavy is ignored.
    :return:
    """
    ...
    if heavy and backend != "gtars":
        ...
        if backend == "gtars" and heavy:
            _LOGGER.info(
                "Heavy processing ignored for gtars backend (no R plots available)"
            )
        else:
